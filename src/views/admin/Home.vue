<template>
    ...
    <AdminLayout>
        ...
        <!--                                    <dl>-->
        <!--                                        <dt class="truncate text-sm font-medium text-gray-500">Account-->
        <!--                                            balance-->
        <!--                                        </dt>-->
        <!--                                        <dd>-->
        <!--                                            <div class="text-lg font-medium text-gray-900">$30,659.45-->
        <!--                                            </div>-->
        <!--                                        </dd>-->
        <!--                                    </dl>-->
        <!--                                </div>-->
        ...
        <!--                            <div class="text-sm">-->
        <!--                                <a href="#" class="font-medium text-cyan-700 hover:text-cyan-900">View-->
        <!--                                    all</a>-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!--                    </div>-->
