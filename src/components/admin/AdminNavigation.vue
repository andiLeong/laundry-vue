<template>
    ...
    <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        <AdminMobileNavigation :links="links" :second-links="secondLinks"></AdminMobileNavigation>
    </div>
        ...
        <div class="flex flex-grow flex-col overflow-y-auto bg-cyan-700 pb-4 pt-5">
            ...
            <nav class="mt-5 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto"
                ...
                <div class="space-y-1 px-2">
                    ...
                    >
                        <component :is="link.svg" class="mr-4 h-6 w-6 flex-shrink-0 text-cyan-200"></component>
                        {{ link.name }}
                    </AppLink>
                </div>
                <div class="mt-6 pt-6">
